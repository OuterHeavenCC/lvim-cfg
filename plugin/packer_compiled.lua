...
local package_path_str = "/home/corentin/.cache/nvim/packer_hererocks/2.0.5/share/lua/5.1/?.lua;/home/corentin/.cache/nvim/packer_hererocks/2.0.5/share/lua/5.1/?/init.lua;/home/corentin/.cache/nvim/packer_hererocks/2.0.5/lib/luarocks/rocks-5.1/?.lua;/home/corentin/.cache/nvim/packer_hererocks/2.0.5/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/home/corentin/.cache/nvim/packer_hererocks/2.0.5/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ["astronauta.nvim"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/astronauta.nvim"
  },
  ["barbar.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/opt/barbar.nvim"
  },
  ["dashboard-nvim"] = {
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/opt/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/nlsp-settings.nvim"
  },
  ["null-ls.nvim"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/null-ls.nvim"
  },
  ["nvim-autopairs"] = {
  ...
  ["nvim-compe"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/opt/nvim-compe",
    wants = { "vim-vsnip" }
  },
  ["nvim-lspconfig"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/nvim-lspconfig"
  },
  ["nvim-lspinstall"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-toggleterm.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/opt/nvim-toggleterm.lua"
  },
  ["nvim-tree.lua"] = {
    ...
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/nvim-tree.lua"
  },
  ["nvim-treesitter"] = {
    ...
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/nvim-treesitter"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/nvim-web-devicons"
  },
  ["packer.nvim"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/packer.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/plenary.nvim"
  },
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/start/popup.nvim"
  },
  ["telescope.nvim"] = {
  ...
  ["which-key.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/corentin/.local/share/lunarvim/site/pack/packer/opt/which-key.nvim"
  }
}
